...
/**
 * Sheet — painel lateral / bottom sheet mobile. Construído sobre o
 * mesmo primitivo Radix Dialog, igual ao componente "sheet" real da
 * Removery Library (o suposto "duplicado" era na verdade um ícone
 * lucide com o mesmo nome — ver seção 2 da auditoria).
 */
